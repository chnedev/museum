...
<html>
    <head>
        ...
        <!-- -->
        <title>XXI Museum | Personalizza profilo</title>
    </head>
    <body>
            ...
            <div class="mui-container-fluid">
                ...
                <c:if test="${tmp=='si'}">
                    <div class="mui--text-subhead mui--text-center mui--align-middle">
                        <span class="icon ion-happy-outline iconbig"></span><br/><br/>MODIFICHE EFFETTUATE CON SUCCESSO<br/><br/><button class="mui-btn mui-btn--raised" onclick="window.location = './profile'">VEDI IL TUO PROFILO</button>
                    </div>
                </c:if>
                <c:if test="${tmp=='no'}">
                    <div class="mui--text-subhead mui--text-center mui--align-middle">
                        <span class="icon ion-sad-outline iconbig"></span><br/><br/>ERRORE DI MODIFICA</div>
                </div>
            </c:if>
        </div>
